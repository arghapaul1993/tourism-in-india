...
const TamilNadu = () => {
  ...
  return (
    ...
    <div>
        <p className='title'>Tourism in Tamil Nadu </p>
...
In the modern times, the Portuguese and French also ruled the area. By the 17th century, the British took control and under their rule, the region was part of Madras Presidency. Post-independence, in the late 1960s, the state of Tamil Nadu was formed.
    ...
    <div>
        ...
        <div className='catogaryDiv'>
            <img src={pic0010} alt="" className='wbimages'/>
        ...
        <div className='catogaryDiv'>
            ...
            <img src={piv002} alt="" className='wbimages'/>

        </div>

        <div className='catogaryDiv'>
        <img src={pic005} alt="" className='wbimages' />
        ...
        <div className='catogaryDiv'>
            ...
            <img src={pic007} alt=""className='wbimages' />

        </div>


        <div className='catogaryDiv'>
        <img src={pic004} alt=""className='wbimages' />
